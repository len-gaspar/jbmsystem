    ...
    <div class="py-12 bg-gray-50/50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <!-- Left Content Area (Job Info & Description) -->
                ...
                <!-- Right Sidebar (Overview Card & Apply Action) -->
                <div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm font-semibold text-gray-800 mt-0.5">
            {{ $job->salary ? '₱ ' . number_format($job->salary, 2) : 'Not specified' }}
                        ...
                        <!-- Replace the existing apply button div with this: -->
...
@if(auth()->id() === $job->user_id)
    <div class="flex gap-2 mt-4">
        <!-- Edit Button -->
        <a href="{{ route('jobs.edit', $job->id) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg">Edit</a>
